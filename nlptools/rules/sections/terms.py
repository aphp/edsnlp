...
antecedents = ['antecedents', 'antecedents medicaux et chirurgicaux',
               'antecedents personnels', 'antecedents medicaux',
...
conclusion = ['au total', 'conclusion', 'conclusion de sortie', 'syntese medicale / conclusion',
              'synthese', 'synthese medicale', 'synthese medicale/conclusion']
...
examens_complementaires = ['examen(s) complementaire(s)', 'examens complementaires',
...
histoire_de_la_maladie = ['histoire de la maladie', 'histoire de la maladie - explorations',

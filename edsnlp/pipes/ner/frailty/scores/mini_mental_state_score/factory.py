...
@registry.factory.register(
    "eds.mini_mental_state_score",
    assigns=["doc.ents", "doc.spans"],
)
def create_component(
    nlp: PipelineProtocol,
    name: Optional[str] = "mini_mental_state_score",
    *,
    ...
    attr: str = "NORM",
    label: str = "mini_mental_state_score",
    span_setter: SpanSetterArg = {
        "ents": True,
        "mini_mental_state_score": True,
    ...
    """
    The `eds.mini_mental_state_score` component extracts mentions of
    the mini_mental_state_score (Mini Mental State) score.

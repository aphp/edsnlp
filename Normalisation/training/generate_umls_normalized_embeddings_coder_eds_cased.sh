#!/bin/bash
#SBATCH --job-name=generate_umls_normalized_embeddings_coder_eds_cased.sh
#SBATCH -t 24:00:00
...
which python
pwd
python /export/home/cse200093/Jacques_Bio/normalisation/py_files/generate_umls_normalized_embeddings_coder_eds_cased.py
echo end

...
class SpanAttributeMetric:
    ...
    | pred                                        | ref                                        |
    +=============================================+============================================+
    | *fièvreux → neg = True*{.chip .tp}          | *fièvreux → neg = True*{.chip .tp}         |
    | *du diabète → neg = False*{.chip .na}       | *du diabète → neg = False*{.chip .na}      |
    | *du diabète → carrier = PATIENT*{.chip .fp} | *du diabète → carrier = FATHER*{.chip .fn} |
    | *cancer → neg = True*{.chip .fp}            | *cancer → neg = False*{.chip .na}          |

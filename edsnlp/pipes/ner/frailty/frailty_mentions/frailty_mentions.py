...
class FrailtyMentionsMatcher(FrailtyDomainMatcher):
    """
    The `eds.frailty_mentions` pipeline component extracts mentions of frailty.
    ...
    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/frailty_mentions/patterns.py"
        # fmt: on
        ```
    ...
    --8<-- "docs/assets/fragments/frailty_mentions-examples.md"
    ...
    def __init__(
        ...
        nlp: Optional[PipelineProtocol],
        *,
        name: str = "frailty_mentions",
        patterns: FullConfig = default_patterns,
        label: str = "frailty_mentions",
        span_setter: SpanSetterArg = {"ents": True, "frailty_mentions": True},
    ):
        super().__init__(
            nlp=nlp,

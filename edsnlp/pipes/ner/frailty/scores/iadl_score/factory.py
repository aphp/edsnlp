...
def create_component(
    ...
    *,
    ...
    """The `eds.iadl_score` component extracts the iadl_score score.
    Nowadays, the iadl_score (Instrumental Activities of Daily Life) score

...
class IncontinenceMatcher(FrailtyDomainMatcher):
    """
    The `eds.incontinence` pipeline component extracts mentions of the incontinence.

    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/incontinence/patterns.py"
        # fmt: on
        ```
    ...
    --8<-- "docs/assets/fragments/incontinence-examples.md"

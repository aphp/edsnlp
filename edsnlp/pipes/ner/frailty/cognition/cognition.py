...
class CognitionMatcher(FrailtyDomainMatcher):
    """
    The `eds.cognition` pipeline component extracts mentions of the cognition.

    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/cognition/patterns.py"
        # fmt: on
        ```
    ...
    - `span._.cognition`: set to None.\n
    It will specify the severity of the mention regarding the cognition
    of the patient.\n
    Possible values are:
    ...
    nlp.add_pipe(f"eds.cognition")
    ```

    Below are a few examples:

    --8<-- "docs/assets/fragments/cognition-examples.md"
    ...
    def __init__(
        ...
        *,
        ...
        label: str = "cognition",
        span_setter: SpanSetterArg = {"ents": True, "cognition": True},
    ):
        super().__init__(
            nlp=nlp,
            domain="cognition",

...
expected_outputs = [
    {
        ...
        "pathology_type": """THROMBOCYTOPENIE -
        HYPOPLASIE ACQUISE MEGACARYOCYTAIRE ET PLAQUETTAIRE (SAI)""",
    ...
    },
    {
        ...
        "pathology": "PATHOLOGIE GÉNÉRALE NON TUMORALE",
        "pathology_type": """INFLAMMATION SUBAIGUE ET
        CHRONIQUE LEGERE TOXIQUE (ALCOOL, ETC)""",
    ...
    },
    {
        ...
        "pathology_type": """CELLULES GLANDULAIRES ATYPIQUES EN FAVEUR
         D'UNE NATURE NEOPLASIQUE - SAI""",

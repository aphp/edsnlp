...
EMBEDDINGS_SAVE_DIR = "/export/home/cse200093/Jacques_Bio/data_bio/normalisation_embeddings/data_embeddings_normalized_snomed_camembert_eds.pt"
...
umls_embedding = get_bert_embed(
    data_df["term"].tolist(), model, tokenizer, tqdm_bar=False
)

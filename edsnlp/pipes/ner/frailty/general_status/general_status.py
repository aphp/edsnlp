...
class GeneralStatusMatcher(FrailtyDomainMatcher):
    """
    The `eds.general_status` pipeline component extracts mentions of the general status.

    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/general_status/patterns.py"
        # fmt: on
        ```
    ...
    --8<-- "docs/assets/fragments/general_status-examples.md"

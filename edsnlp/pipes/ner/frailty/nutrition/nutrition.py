...
class NutritionMatcher(FrailtyDomainMatcher):
    """
    The `eds.nutrition` pipeline component extracts mentions of the nutrition.

    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/nutrition/patterns.py"
        # fmt: on
        ```
    ...
    It will specify the severity of the mention regarding the nutrition
    of the patient.\n
    Possible values are:
    ...
    --8<-- "docs/assets/fragments/nutrition-examples.md"

...
class ThymicMatcher(FrailtyDomainMatcher):
    """
    The `eds.thymic` pipeline component extracts mentions of the thymic status.

    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/thymic/patterns.py"
        # fmt: on
        ```
    ...
    --8<-- "docs/assets/fragments/thymic-examples.md"

...
def create_component(
    ...
    *,
    ...
    """
    The `eds.mini_gds_score` component extracts mentions of
    the mini-geriatric_depression_scale_score (mini Geriatric Depression Scale) score.

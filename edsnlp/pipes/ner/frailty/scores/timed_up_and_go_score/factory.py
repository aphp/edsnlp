...
@registry.factory.register(
    "eds.timed_up_and_go_score",
    assigns=["doc.ents", "doc.spans"],
)
def create_component(
    nlp: PipelineProtocol,
    name: Optional[str] = "timed_up_and_go_score",
    *,
    ...
    attr: str = "NORM",
    label: str = "timed_up_and_go_score",
    span_setter: SpanSetterArg = {
        "ents": True,
        "timed_up_and_go_score": True,
    ...
    """
    The `eds.timed_up_and_go_score` component extracts mentions of
    the timed_up_and_go_score (Timed Up and Go) score.

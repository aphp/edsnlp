...
# Defining save paths
DES_SAVE_DIR = "/export/home/cse200093/Jacques_Bio/data_bio/normalisation_embeddings/umls_normalized_des_coder_eds_2_cased.pkl"
LABEL_SAVE_DIR = "/export/home/cse200093/Jacques_Bio/data_bio/normalisation_embeddings/umls_normalized_label_coder_eds_2_cased.pkl"
EMBEDDINGS_SAVE_DIR = "/export/home/cse200093/Jacques_Bio/data_bio/normalisation_embeddings/umls_normalized_embeddings_coder_eds_2_cased.pt"
...
umls_raw["STR"] = umls_raw["STR"].apply(
    lambda syn: re.compile(regex_words_to_remove, re.IGNORECASE).sub("", syn)
)
umls_raw["STR"] = umls_raw["STR"].apply(
    lambda syn: re.compile(regex_remove_special_characters, re.IGNORECASE).sub("", syn)
)

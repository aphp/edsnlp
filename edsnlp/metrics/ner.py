...
class NerExactMetric(NerMetric):
    ...
    | pred                                    | ref                                   |
    +=========================================+=======================================+
    | *La*{.chip .fp data-chip=PER}           | *patiente*{.chip .tp data-chip=PER}   |
    | *patiente*{.chip .tp data-chip=PER}     | *une fièvre*{.chip .fp data-chip=DIS} |
...
class NerTokenMetric(NerMetric):
    ...
    **token** level.
    ...
    +=====================================+=====================================+
    | *La*{.chip .fp data-chip=PER}       | *patiente*{.chip .tp data-chip=PER} |
    | *patiente*{.chip .tp data-chip=PER} | *une*{.chip .fp data-chip=DIS}      |
    | *fièvre*{.chip .tp data-chip=DIS}   | *fièvre*{.chip .tp data-chip=DIS}   |
...
class NerOverlapMetric(NerMetric):
    ...
    +=========================================+=======================================+
    | *La*{.chip .fp data-chip=PER}           | *patiente*{.chip .tp data-chip=PER}   |
    | *patiente*{.chip .tp data-chip=PER}     | *une fièvre*{.chip .tp data-chip=DIS} |
    | *fièvre aiguë*{.chip .tp data-chip=DIS} |                                       |
    +-----------------------------------------+---------------------------------------+

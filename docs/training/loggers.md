...
!!! note "Draft objects"
    ...
    `edsnlp.train` will provide a default project name and logging dir for loggers that require these parameters, but it is recommended to set the project name explicitly in the logger configuration. For these loggers, if you don't want to set the project name yourself, you can either:

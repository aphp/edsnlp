...
def moca_severity_assigner(ent: Span):
...
def create_component(
    ...
    *,
    ...
    severity_assigner: Callable[[Span], Any] = moca_severity_assigner,
):
    """
    The `eds.moca_score` component extracts mentions of
    the moca_score (Montreal Cognitive Assessment) score.

...
factories = [
    ...
    "adrenal_insufficiency = edsnlp.components:adrenal_insufficiency",
    "myasthenia = edsnlp.components:myasthenia",
    "atrial_fibrillation = edsnlp.components:atrial_fibrillation",
    "hypertension = edsnlp.components:hypertension",

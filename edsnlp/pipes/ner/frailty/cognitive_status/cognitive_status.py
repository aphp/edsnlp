...
class CognitiveStatusMatcher(FrailtyDomainMatcher):
    """
    The `eds.cognitive_status` pipeline component extracts mentions of the
    cognitive status.

    ??? info "Details of the used patterns"
        ```{ .python .no-check }
        # fmt: off
        --8<-- "edsnlp/pipes/ner/frailty/cognitive_status/patterns.py"
        # fmt: on
        ```
    ...
    It will specify the severity of the mention regarding the cognitive status
    of the patient.\n
    Possible values are:
    ...
    --8<-- "docs/assets/fragments/cognitive_status-examples.md"
    ...
    def __init__(
        ...
        nlp: Optional[PipelineProtocol],
        *,
        name: str = "cognitive_status",
        patterns: FullConfig = default_patterns,
        label: str = "cognitive_status",
        span_setter: SpanSetterArg = {"ents": True, "cognitive_status": True},
    ):
        super().__init__(
            nlp=nlp,

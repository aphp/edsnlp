...
@registry.factory.register(
    "eds.clinical_frailty_scale_score",
    assigns=["doc.ents", "doc.spans"],
)
def create_component(
    nlp: PipelineProtocol,
    name: Optional[str] = "clinical_frailty_scale_score",
    *,
    patterns: List[Dict] = default_patterns,
    score_normalization: Union[str, Callable[[Span], Any]] = score_normalization,
    attr: str = "NORM",
    label: str = "clinical_frailty_scale_score",
    span_setter: SpanSetterArg = {
        "ents": True,
        "clinical_frailty_scale_score": True,
    ...
    """
    The `eds.clinical_frailty_scale_score` component extracts mentions of
    the clinical_frailty_scale_score score.

...
| `eds.doc_pooler`          | A doc embedding component that aggregates word embeddings             |
...
| `eds.doc_classifier`      | A trainable component for multi-head document classification          |

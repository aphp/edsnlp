...
def sppb_severity_assigner(ent: Span):
...
def create_component(
    ...
    name: Optional[str] = "sppb",
    *,
    patterns: List[Dict] = default_patterns,
    score_normalization: Union[
        str, Callable[[Span], Any]
    ] = make_find_value_and_reference(admissible_references=[12], default_reference=12),
    attr: str = "NORM",
    label: str = "sppb",
    span_setter: SpanSetterArg = {"ents": True, "sppb": True, "mobility": True},
    include_assigned: bool = True,
    severity_assigner: Callable[[Span], Any] = sppb_severity_assigner,
):
    """
    The `eds.sppb` component extracts mentions of
    the SPPB (Short Physical Performance Battery) score.

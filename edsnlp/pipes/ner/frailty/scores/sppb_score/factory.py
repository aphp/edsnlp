...
def create_component(
    ...
    *,
    ...
    """
    The `eds.sppb_score` component extracts mentions of
    the sppb_score (Short Physical Performance Battery) score.

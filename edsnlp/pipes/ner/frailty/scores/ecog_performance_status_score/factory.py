...
@registry.factory.register(
    "eds.ecog_performance_status_score",
    assigns=["doc.ents", "doc.spans"],
)
def create_component(
    nlp: PipelineProtocol,
    name: Optional[str] = "ecog_performance_status_score",
    *,
    patterns: List[Dict] = default_patterns,
    score_normalization: Union[str, Callable[[Span], Any]] = score_normalization,
    attr: str = "NORM",
    label: str = "ecog_performance_status_score",
    span_setter: SpanSetterArg = {
        "ents": True,
        "ecog_performance_status_score": True,
    ...
    """
    The `eds.ecog_performance_status_score` component extracts mentions of

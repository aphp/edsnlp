context_examples = [
    {
        ...
        "entities": [
            {"start": 27, "end": 42, "context": "FAMILY", "context_pymedext": "family"}
        ],
    },
    {
        "text": "Antécédents familiaux : diabète.",
        "entities": [
            {"start": 24, "end": 31, "context": "FAMILY", "context_pymedext": "family"}
        ],
    },
    {
        "text": "Un relevé sanguin a été effectué.",
        "entities": [
            {"start": 3, "end": 17, "context": "PATIENT", "context_pymedext": "patient"}
        ],
    },
]
...
negation_examples = [
    {
        ...
        "entities": [
            {"start": 21, "end": 27, "polarity": "NEG", "polarity_pymedext": "neg"}
        ],
    },
    {
        "text": "Aucun traitement.",
        "entities": [
            {"start": 6, "end": 16, "polarity": "NEG", "polarity_pymedext": "neg"}
        ],
    },
    {
        "text": "Le scan révèle une grosseur.",
        "entities": [
            {"start": 8, "end": 14, "polarity": "AFF", "polarity_pymedext": "aff"}
        ],
    },
]
